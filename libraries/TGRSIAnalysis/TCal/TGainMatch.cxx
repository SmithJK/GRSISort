...
//This is more useful as it allows a script to find all of the peaks.
   ...
   for(int x=0;x<nFound;x++) {
      if(fabs(peak1->GetCentroid() - s.GetPositionX()[x]) < closestDiff) {
         closestPeak = s.GetPositionX()[x];
         closestDiff = fabs(peak1->GetCentroid() - s.GetPositionX()[x]);
      }
   }
...
//   peak1->SetRange(((peak1->GetXmin()-offset)/gain)*fAlignCoeffs[1] + fAlignCoeffs[0],((peak1->GetXmax()-offset)/gain)*fAlignCoeffs[1] + fAlignCoeffs[0]);
//   peak2->SetRange(((peak2->GetXmin()-offset)/gain)*fAlignCoeffs[1] + fAlignCoeffs[0],((peak2->GetXmax()-offset)/gain)*fAlignCoeffs[1] + fAlignCoeffs[0]);
   peak1->SetRange(((peak1->GetXmin()*fAlignCoeffs[1]+fAlignCoeffs[0] -offset)/gain),((peak1->GetXmax()*fAlignCoeffs[1] + fAlignCoeffs[0]-offset)/gain));
   peak2->SetRange(((peak2->GetXmin()*fAlignCoeffs[1]+fAlignCoeffs[0] -offset)/gain),((peak2->GetXmax()*fAlignCoeffs[1] + fAlignCoeffs[0]-offset)/gain));
